...
(cl:defmethod cl:initialize-instance :after ((m <Rect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jsk_recognition_msgs-msg:<Rect> is deprecated: use jsk_recognition_msgs-msg:Rect instead.")))
