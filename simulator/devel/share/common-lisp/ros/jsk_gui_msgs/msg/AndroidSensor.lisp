...
(cl:defmethod cl:initialize-instance :after ((m <AndroidSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AndroidSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jsk_gui_msgs-msg:<AndroidSensor> is deprecated: use jsk_gui_msgs-msg:AndroidSensor instead.")))

(cl:ensure-generic-function 'accel_x-val :lambda-list '(m))
(cl:defmethod accel_x-val ((m <AndroidSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_gui_msgs-msg:accel_x-val is deprecated.  Use jsk_gui_msgs-msg:accel_x instead.")
  (accel_x m))

(cl:ensure-generic-function 'accel_y-val :lambda-list '(m))
(cl:defmethod accel_y-val ((m <AndroidSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_gui_msgs-msg:accel_y-val is deprecated.  Use jsk_gui_msgs-msg:accel_y instead.")
  (accel_y m))

(cl:ensure-generic-function 'accel_z-val :lambda-list '(m))
(cl:defmethod accel_z-val ((m <AndroidSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_gui_msgs-msg:accel_z-val is deprecated.  Use jsk_gui_msgs-msg:accel_z instead.")
  (accel_z m))

(cl:ensure-generic-function 'orientation_x-val :lambda-list '(m))
(cl:defmethod orientation_x-val ((m <AndroidSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_gui_msgs-msg:orientation_x-val is deprecated.  Use jsk_gui_msgs-msg:orientation_x instead.")
  (orientation_x m))

(cl:ensure-generic-function 'orientation_y-val :lambda-list '(m))
(cl:defmethod orientation_y-val ((m <AndroidSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_gui_msgs-msg:orientation_y-val is deprecated.  Use jsk_gui_msgs-msg:orientation_y instead.")
  (orientation_y m))

(cl:ensure-generic-function 'orientation_z-val :lambda-list '(m))
(cl:defmethod orientation_z-val ((m <AndroidSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jsk_gui_msgs-msg:orientation_z-val is deprecated.  Use jsk_gui_msgs-msg:orientation_z instead.")
  (orientation_z m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AndroidSensor>)))
  ...
  "d832dbe3be7e7f061d963f2188f1a407")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AndroidSensor)))
  "Returns md5sum for a message object of type 'AndroidSensor"
  "d832dbe3be7e7f061d963f2188f1a407")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AndroidSensor>)))
  ...
  (cl:format cl:nil "# sonsor for Tablet~%float64 accel_x~%float64 accel_y~%float64 accel_z~%float64 orientation_x~%float64 orientation_y~%float64 orientation_z~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AndroidSensor)))
  "Returns full string definition for message of type 'AndroidSensor"
  (cl:format cl:nil "# sonsor for Tablet~%float64 accel_x~%float64 accel_y~%float64 accel_z~%float64 orientation_x~%float64 orientation_y~%float64 orientation_z~%~%~%~%~%"))
